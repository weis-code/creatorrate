        ...
        <div className="max-w-xl mx-auto">
          ...
          <div className="flex items-center gap-4">
            <button
              ...
              className="relative w-14 h-14 rounded-2xl overflow-hidden group flex-shrink-0 border border-white/30"
              title="Skift profilbillede"
            >
              {avatarUrl ? (
                <img src={avatarUrl} alt="Avatar" className="w-full h-full object-cover" />
              ) : (
                <div className="w-full h-full bg-white/20 backdrop-blur-sm flex items-center justify-center text-white font-bold text-xl">
                  {initials}
                </div>
              )}
...
function UpgradeToCreator() {
  ...
  const features = ['Svar på alle anmeldelser', 'Creator profil', 'Disputer anmeldelser', 'Prioritet support']
  ...
  return (
    <div className="mt-8 bg-gradient-to-br from-indigo-50 to-purple-50 rounded-2xl border border-indigo-100 p-6">
      ...
      <div className="bg-white rounded-xl border-2 border-indigo-600 p-4 mb-5">
        <div className="font-bold text-gray-900 text-sm">Pro</div>
        <div className="text-base font-extrabold text-indigo-600 mb-2">$5/md</div>
